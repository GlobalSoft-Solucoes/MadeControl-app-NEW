...
import 'DetalhesEstProduto.dart';

class EstatisticaProduto extends StatefulWidget {
  @override
  _EstatisticaProdutoState createState() => _EstatisticaProdutoState();
}
class ProdutoOuPallet{
 static RxBool? opcProduto = false.obs;
}

class _EstatisticaProdutoState extends State<EstatisticaProduto> {
                              ...
                              title: Column(
                                ...
                                children: [
                                  FieldsDatabase().listaDadosBanco(
                                    'Número de produtos: ',
                                    FieldsEstatisticaProdutos.qtdprodutos,
                                    sizeCampoBanco: 20,
                                    sizeTextoCampo: 20,
                                  ),
                                  SizedBox(height: 12),
                                  FieldsDatabase().listaDadosBanco(
                                    ...
                                    FieldsEstatisticaProdutos.qtdPedidosTotal,
                                    sizeCampoBanco: 20,
                                    sizeTextoCampo: 20,
                                  ),
                                  SizedBox(height: 12),
                                    ...
                                    return Padding(
                                      ...
                                      child: Padding(
                                        ...
                                        child: GestureDetector(
                                          onTap: () async {
                                            dadosListagem[index].idProduto != null?
                                            ProdutoOuPallet.opcProduto!.value = true:
                                            ProdutoOuPallet.opcProduto!.value = false;
                                            await FieldsEstatisticaProdutos()
                                                .buscaDadosAnoProdutoPorid(
                                                    anoEscolhido,
                                                     dadosListagem[index]
                                                            .idProduto != null
                                                    ? dadosListagem[index]
                                                        .idProduto: dadosListagem[index]
                                                        .idPallet );
                                            FieldsEstatisticaProdutos
                                                    .nomeProduto =
                                                dadosListagem[index]
                                              ...
                                              child: ListTile(
                                                title: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    FieldsDatabase()
                                                        .listaDadosBanco(
                                                      'Representação faturamento ano: ',
                                                      dadosListagem[index]
                                                              .percentualMediaVendaAno! +
                                                          '%',
                                                    )
                                                  ],
                                                ),
