...
import 'DetalhesEstFaturamento.dart';

class EstatisticaFaturamento extends StatefulWidget {
  @override
  _EstatisticaFaturamentoState createState() => _EstatisticaFaturamentoState();
}

class _EstatisticaFaturamentoState extends State<EstatisticaFaturamento> {
  ...
  Future<dynamic> listarDados() async {
    final response = await http.get(
      Uri.parse(ListaMesesFaturamentoPorAno +
          anoEscolhido +
          '/' +
                            ...
                            child: ListTile(
                              title: Column(
                                ...
                                children: [
                                  ...
                                  FieldsDatabase().listaDadosBanco(
                                    'Número de meses: ',
                                    FieldsEstatisticaFaturamento.qtdMeses,
                                    sizeCampoBanco: 21,
                                    sizeTextoCampo: 21,
                                  ),
                                  SizedBox(height: 10),
                                  FieldsDatabase().listaDadosBanco(
                                    'Média faturamento por mês: ',
                                    FieldsEstatisticaFaturamento
                                        .mediaFaturamentoMes,
                                    sizeCampoBanco: 20,
                                    sizeTextoCampo: 20,
